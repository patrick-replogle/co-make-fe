      ...
      <div className="aboutPageContainer">
        <div>
          ...
          <div className="aboutPageText">
            ...
            <p>
              CoMake is a social media app that provides users with a platform
              to get involved in their local community. Want to call attention
              to an issue in your neighborhood? Maybe you would like to
